                    ...
                    <div className="col-span-2 md:col-span-2 pr-8">
                        ...
                        <div className="flex gap-4">
                            {socialLinks.map((link, i) => (
                                <a key={i} href={link.href} className="text-foreground/70 hover:text-primary transition-colors">
                                    {link.icon}
                                </a>
                            ))}
                        </div>
                    ...
                    {Object.entries(footerLinks).map(([title, links]) => (
                        <div key={title}>
                            ...
                            <ul className="space-y-3">
                                {links.map(link => (
                                    <li key={link}>
                                        <a href="#" className="text-foreground/70 hover:text-foreground transition-colors">{link}</a>
                                    </li>
                                ))}
                            </ul>
                        </div>

  ...
  const pricingPlans = [
    {
      ...
      features: [
        "Real time dashboard tracking your progress",
        "Create your own Modules of your favourite topics",
        "Limited module creations",
        "Upto 1 community support",
        "limited time session with AI tutor",
      ],
    ...
    },
    {
      ...
      monthlyPrice: "$20",
      annualPrice: "$16",
      description: "Ideal for passionate learners.",
      features: [
        "Create your own Modules of your favourite topics",
        "Unlimited module creations",
        "Join any community and community support",
        "Longer sessions with AI tutor",
    ...
    },
    {
      ...
      monthlyPrice: "$50",
      annualPrice: "$45",
      description: "Tailored solutions for deep learners",
      features: [
        "Create your own Modules of your favourite topics",
        "Unlimited module creations",
        "Join any community and community support",
        "You can create and host your own community",
